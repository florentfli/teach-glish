        ...
        <div v-else-if="!gameOver">
            ...
            <div v-else class="justify-content-sm-center row">
                ...
                <div id="col-12 audio-container">
                    ...
                    <audio v-if="sounds[theme][currentIndex] == 'dog'" controls="controls" preload="auto" :src="url('..\assets\sounds\dog.mp3')">
                        Your browser does not support the audio tag.
                    </audio>    
                    <audio v-if="sounds[theme][currentIndex] == 'duck'" controls="controls" preload="auto" :src="url('..\assets\sounds\duck.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
                    <audio v-if="sounds[theme][currentIndex] == 'elephant'" controls="controls" preload="auto" :src="url('..\assets\sounds\elephant.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
                    <audio v-if="sounds[theme][currentIndex] == 'goat'" controls="controls" preload="auto" :src="url('..\assets\sounds\goat.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
                    <audio v-if="sounds[theme][currentIndex] == 'sheep'" controls="controls" preload="auto" :src="url('..\assets\sounds\sheep.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
                    ...
                    <audio v-if="sounds[theme][currentIndex] == 'trumpet'" controls="controls" preload="auto" :src="url('..\assets\sounds\trumpet.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
