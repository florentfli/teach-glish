        ...
        <div v-else-if="!gameOver">
            ...
            <div v-else class="justify-content-sm-center row">
                ...
                <div id="col-12 audio-container">
                    <!-- ANIMALS -->
                    <audio v-if="sounds[theme][currentIndex] == 'cat'" controls="controls" preload="auto" :src="url('../assets/sounds/cat.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
                    <audio v-if="sounds[theme][currentIndex] == 'cicada'" controls="controls" preload="auto" :src="url('../assets/sounds/cicada.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
                    <audio v-if="sounds[theme][currentIndex] == 'cricket'" controls="controls" preload="auto" :src="url('../assets/sounds/cricket.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
                    <audio v-if="sounds[theme][currentIndex] == 'donkey'" controls="controls" preload="auto" :src="url('../assets/sounds/donkey.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
                    <audio v-if="sounds[theme][currentIndex] == 'dog'" controls="controls" preload="auto" :src="url('/assetsd/soundsd/dog.mp3')">
                        Your browser does not support the audio tag.
                    </audio>    
                    <audio v-if="sounds[theme][currentIndex] == 'duck'" controls="controls" preload="auto" :src="url('/assetsd/soundsd/duck.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
                    <audio v-if="sounds[theme][currentIndex] == 'elephant'" controls="controls" preload="auto" :src="url('/assetsd/soundsd/elephant.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
                    <audio v-if="sounds[theme][currentIndex] == 'goat'" controls="controls" preload="auto" :src="url('/assetsd/soundsd/goat.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
                    <audio v-if="sounds[theme][currentIndex] == 'sheep'" controls="controls" preload="auto" :src="url('/assetsd/soundsd/sheep.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
                    <audio v-if="sounds[theme][currentIndex] == 'wolf'" controls="controls" preload="auto" :src="url('/assets/sounds/wolf.mp3')">
                        Your browser does not support the audio tag.
                    </audio>

                    <!-- COMMONS -->
                    <audio v-if="sounds[theme][currentIndex] == 'car'" controls="controls" preload="auto" :src="url('../assets/sounds/car.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
                    <audio v-if="sounds[theme][currentIndex] == 'plane'" controls="controls" preload="auto" :src="url('../assets/sounds/plane.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
                    <audio v-if="sounds[theme][currentIndex] == 'doorbell'" controls="controls" preload="auto" :src="url('../assets/sounds/doorbell.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
                    <audio v-if="sounds[theme][currentIndex] == 'fireworks'" controls="controls" preload="auto" :src="url('../assets/sounds/fireworks.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
                    <audio v-if="sounds[theme][currentIndex] == 'helicopter'" controls="controls" preload="auto" :src="url('../assets/sounds/helicopter.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
                    <audio v-if="sounds[theme][currentIndex] == 'siren'" controls="controls" preload="auto" :src="url('../assets/sounds/siren.mp3')">
                        Your browser does not support the audio tag.
                    </audio>

                    <!-- INSTRUMENT -->
                    <audio v-if="sounds[theme][currentIndex] == 'cello'" controls="controls" preload="auto" :src="url('../assets/sounds/cello.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
                    <audio v-if="sounds[theme][currentIndex] == 'drums'" controls="controls" preload="auto" :src="url('../assets/sounds/drums.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
                    <audio v-if="sounds[theme][currentIndex] == 'guitar'" controls="controls" preload="auto" :src="url('../assets/sounds/guitar.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
                    <audio v-if="sounds[theme][currentIndex] == 'piano'" controls="controls" preload="auto" :src="url('../assets/sounds/piano.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
                    <audio v-if="sounds[theme][currentIndex] == 'trumpet'" controls="controls" preload="auto" :src="url('../assets/sounds/trumpet.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
                    <audio v-if="sounds[theme][currentIndex] == 'violin'" controls="controls" preload="auto" :src="url('../assets/sounds/violin.mp3')">
                        Your browser does not support the audio tag.
                    </audio>
                </div>
